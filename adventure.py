...
def create_room(name, description, itemsinroom, ends_game=False):
...
##
classroom = create_room("classroom", "You're in a lecture hall, for some reason.", ['pencils', 'chairs', 'pens'])
classroom_106 = create_room("classroom_14", "You're in a computer lab, trying to hack the government.", ['computers', 'trashcan', 'television'])
